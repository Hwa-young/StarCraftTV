...
static NSString * const kSearchURL                  = @"https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&type=video&videoType=any&regionCode=KR&channelId=UCX1DpoQkBN4rv5ZfPivA_Wg&order=date";
...
static NSString * const kSearchPlaylistURL          = @"https://www.googleapis.com/youtube/v3/search?part=snippet&type=playlist";
